...
import { DefaultScript, CellDirection, MoverScript, Board, EnemyScript, TrashScript } from "./types";
...
const cells: Cell[] = [
	...
	new Cell("st", "trash", "./../assets/img/cells/trash.png", "Trash", selectRotation, TrashScript),
]
...
if (container != null) {
	...
	startElement.addEventListener("click", function(ev) {
		if (running == false) {
			running = true;
			save = board;
		}
